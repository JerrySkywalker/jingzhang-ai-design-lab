...
| Pre-downselect | `docs/ROUND3_RED_TEAM.md`, `docs/CANDIDATE_COMPARISON_V0.3.md` | pending | non-binding dispositions |

Every final disposition must trace to this index and state uncertainty plus what would change it.
