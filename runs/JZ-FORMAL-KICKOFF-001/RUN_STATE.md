...
OFFICIAL_HEAD_END=5cef3aa58a8306450684bd1d64ff651fd6b51e4b
...
The official main moved non-monotonically during bootstrap, then advanced again. At final refresh it added `completeness_limited_by` to the design-depth contract and retained the complete-only formal gate; the participant branch merged that exact official head normally and re-ran affected checks. No participant action attempted to repair, rewrite or push upstream.
